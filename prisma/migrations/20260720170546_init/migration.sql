...
-- CreateIndex
CREATE INDEX "tasks_company_id_project_id_idx" ON "tasks"("company_id", "project_id");

-- CreateIndex
CREATE INDEX "tasks_company_id_assignee_id_idx" ON "tasks"("company_id", "assignee_id");
